<?php $title = "Construção Civil" ?>
<?php include "./src/views/includes/head.php" ?>

<style>
  header figure {
    background-image: url("./src/assets/img/servicos/construcao-civil.jpg");
...
<section>
  ...
  <div>
    ...
    <ul>
      ...
      <li>Infraestrutura (fundação, laje, etc);</li>
      <li>Supra Estrutura (vedação, Pilar, Parede, etc);</li>
      <li>Cobertura (Forro/Telhado);</li>
      <li>Esquadrias, Revestimentos e Pinturas;</li>
    ...
    <ul>
      ...
      <li>Sondagem e Topografia;</li>
      <li>Limpeza, Manutenção e Conservação de Galerias;</li>
      <li>Obras de Arte (Viaduto, Tuneis, Pontes, etc);</li>
    ...
    <ul>
      ...
      <li>Projeto de AVCB , As Built, Habite-se, etc;</li>
      <li>Projeto Estrutural e Executivo;</li>
      <li>Projeto de Compensação Ambiental;</li>
    ...
    <ul>
      ...
      <li>Projeto Executivo e As Built (Infra, Redes e outros.);</li>
      <li>Canalização subterrânea para Telefonia;</li>
      <li>Cabeamento Estruturado e Fibra Óptica;</li>
      <li>Certificação de Cabeamento e Redes; </li>
      <li>Instalação de equipamentos eletrônicos.</li>
    </ul>
  </div>
</section>
