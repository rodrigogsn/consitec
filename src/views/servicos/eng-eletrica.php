<?php $title = "Engenharia Elétrica" ?>
<?php include "./src/views/includes/head.php" ?>

<style>
  header figure {
    background-image: url("./src/assets/img/servicos/eng-eletrica.jpg");
...
<section>
  ...
  <div>
    ...
    <p>
      Nossos especialistas trabalham nos mais diferentes mercados, aplicando o conhecimento técnico e prático para entregar soluções de engenharias para ativos de qualquer tipo e escala.
    </p>
  </div>
</section>
